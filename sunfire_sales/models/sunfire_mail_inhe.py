...
class MailComposer(models.TransientModel):
    ...
    email_cc_ids = fields.Many2many('res.partner', 'mail_compose_message_res_partner_cc_rel', 'wizard_id', 'partner_cc_id', string='Cc', default=_get_default_cc_ids)
    email_bcc_ids = fields.Many2many('res.partner', 'mail_compose_message_res_partner_bcc_rel', 'wizard_id', 'partner_bcc_id', string='Bcc', default=_get_default_bcc_ids)
...
class res_company(models.Model):
    ...
    default_cc = fields.Many2many('res.partner', 'rel_cc_partner_ids', 'company_id', 'partner_cc_id', string="Cc")
    default_bcc = fields.Many2many('res.partner', 'rel_bcc_partner_ids', 'company_id', 'partner_bcc_id', string="Bcc")
    is_cc_visible = fields.Boolean(string="Cc ", default=True)
    is_bcc_visible = fields.Boolean(string="Bcc ", default=True)
